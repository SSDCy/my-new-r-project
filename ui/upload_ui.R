      ...
      column(12, 
             ...
             div(class = "card-modern",
                 ...
                 div(style = "padding: 20px;",
                     ...
                     # 数据质量分析按钮（动态文本）
                     conditionalPanel(
                       condition = "input.show_quality % 2 == 0 || input.show_quality === null",
                       actionButton("show_quality", "Show Data Quality Analysis", 
                                    icon = icon("chart-bar"), class = "btn-info btn-lg btn-block")
                     ),
                     conditionalPanel(
                       condition = "input.show_quality % 2 == 1",
                       actionButton("show_quality", "Hide Data Quality Analysis", 
                                    icon = icon("chart-bar"), class = "btn-warning btn-lg btn-block")
                     ),
                     conditionalPanel(
                       condition = "input.show_quality % 2 == 1",
